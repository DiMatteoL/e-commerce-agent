...
This is a sample document for testing purposes. You can replace this text with your own content.

# Sample Document

This document contains information that can be used for retrieval and question answering.
...
## Usage
Simply replace this text with your own content and upload it to start using the chat system.
`.trim();
